...
tf.app.flags.DEFINE_string("attention", "bidaf_selfattn_parallel", "basicattn, bidaf, selfattn, rnet, bidaf_selfattn_parallel, bidaf_selfattn_piped, bidaf_rnet_parallel, bidaf_rnet_piped, arch1")
