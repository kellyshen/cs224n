...
tf.app.flags.DEFINE_string("attention", "BiDAFSelfAttn_k", "Type of attention to be used. Options: BasicAttn, BiDAF, SelfAttn, Rnet, BiDAFSelfAttn, BiDAFSelfAttn_k, BiDAFRnet.")
